...
<div id="container">
    ...
    <form:form modelAttribute="newCVForm" method="POST" action="${contextPath}/generatecv" class="form-generatecv">
        ...
        <div class="form-group">
            ...
            <form:input id="cvFirstName" path="firstName" name="firstName" type="text" class="form-control" autofocus="true"/>
            ...
            <form:textarea id="cvWorkExperience" path="workExperience" name="workExperience" rows="4" cols="100"></form:textarea>

            <input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}"/>


            <button style="display: none" name="submitButton1" class="btn btn-lg btn-primary btn-block" type="submit">Submit CV</button>
        </div>
